            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-6" style="text-align: right;">
                  <a class="btn btn-success" href="region-new.php"><i class="fas fa-plus"></i>&emsp;Create Region</a>
                </div>
                  ...
                  <tbody>
                    <?php
                      while($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                          <td><?php echo $row['nameen']?></td>
                          <td><?php echo $row['namemm']?></td>
                          
                          <td><?php echo $row['lattitude']?></td>
                          <td><?php echo $row['longtitude']?></td>
                          <td>
                            <a href="region-detail.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-dark"><i class="fas fa-eye"></i></a>&emsp;&emsp;    
                            <a href="region-update.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>&emsp;&emsp;
                            <a href="region-delete.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-danger"><i class="fas fa-trash"></i></a>                   
                          </td>
                         </tr>
