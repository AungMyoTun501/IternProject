            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-6" style="text-align: right;">
                  <a class="btn btn-success" href="place-new.php"><i class="fas fa-plus"></i>&emsp;Create Place</a>
                </div>
                    ...
                    <?php
                      while($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                         ...
                         <td>
                            <a href="place-detail.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-dark"><i class="fas fa-eye"></i></a>&emsp;&emsp;
                            
                            <a href="place-update.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>&emsp;&emsp;
                            <a href="place-delete.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-danger"><i class="fas fa-trash"></i></a>
